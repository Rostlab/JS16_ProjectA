...
* To delete the collection and fill it again (new _ids are set!) with scraped data use: npm run refill --collection=x
...
x is a placeholder and has to be replaced by the intended collection. (e.g. characters)
